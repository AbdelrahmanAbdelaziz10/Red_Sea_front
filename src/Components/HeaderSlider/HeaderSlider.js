...
function HeaderSlider({ slider }) {
  ...
  return (
    ...
    // >
    //   {slider.map((slide) =>
    //     // <div data-src={`https://beautyproducts.website/${slide?.slider}`} />
    //     slide?.slider !== null ? (
    //       <div data-src={`https://beautyproducts.website/${slide?.slider}`} />
    //     ) : (
    //       //   <img src={`https://beautyproducts.website/${slide?.slider}`} alt="" />
      ...
      >
        {slider &&
          slider.map((slide, idx) => (
            <div
              key={slide.id}
              data-src={`https://beautyproducts.website/${slide.slider}`}
            >
              {slide.video_url ? (
